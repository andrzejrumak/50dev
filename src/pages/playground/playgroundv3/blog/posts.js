export const posts = [
  ...
  },
  {
    id: 3,
    r: 'nuxt3beta',
    title: 'Nuxt 3 beta public',
    content: 'Finally, after a year of waiting, we can see the new version of the Vue framework - Nuxt version 3.',
    likes: '',
    hashtags: [
      'nuxt',
    ],
  },
  {
    ...
    r: 'vue32',
    title: 'Vue 3.2',
    content: 'Vue version 3.2 What is new? - script setup, style v-binde',
    likes: 21,
    hashtags: [
      'vue',
    ],
  },
  {
    ...
    r: 'whyNuxt3',
    title: 'Why Nuxt 3',
    content: 'The third version of the Nuxt famework has been expected for over a year now. Is it worth to wait?',
    likes: 33,
    hashtags: [
      'nuxt',
    ],
